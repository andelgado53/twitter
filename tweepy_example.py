...
def insert_tweets_into_MongoDB(list_of_tweets, collection):	
    ...
    try:
        ...
        print(str(len(list_of_tweets)) + ' tweets were pulled. '
              + str(len(to_insert)) +
              ' tweets not already saved were inserted')
        print(tc.count(), 'tweets in tweets collection')
    except :
        print(str(len(list_of_tweets)) + ' tweets were fetched - all already in the collection. '
              + str(len(to_insert)) + ' were inserted')
